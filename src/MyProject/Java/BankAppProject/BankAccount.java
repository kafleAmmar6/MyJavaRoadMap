package MyProject.Java.BankAppProject;
import java.util.*;
...
BankAccount {
    ...
    public static void main(String[] args) {
        ...
        List<MyProject.Java.BankAppProject.DetailOfBank> customers = new LinkedList<>();
                ...
                case 1:
                    ...
                    try {
                        ...
                        if (customerName.trim().isEmpty())
                            throw new MyProject.Java.BankAppProject.BankAccountException("Name cannot be empty!");
                        if (!customerName.matches("[a-zA-Z ]+"))
                            throw new MyProject.Java.BankAppProject.BankAccountException("Name cannot be numeric!");

                        System.out.print("Enter Customer Address: ");
                        String customerAddress = sc.nextLine();
                        if (customerAddress.trim().isEmpty())
                            throw new MyProject.Java.BankAppProject.BankAccountException("Address cannot be empty!");

                        System.out.print("Enter Customer Phone Number: ");
                        String customerPhone = sc.nextLine();
                        if (!customerPhone.matches("\\d{10}"))
                            throw new MyProject.Java.BankAppProject.BankAccountException("Phone number must be 10 digits!");

                        System.out.print("Enter Customer E-mail: ");
                        String customerEmail = sc.nextLine();
                        if (!customerEmail.contains("@gmail.com"))
                            throw new MyProject.Java.BankAppProject.BankAccountException("Invalid email format!");
                        ...
                        MyProject.Java.BankAppProject.DetailOfBank customerAccount = new MyProject.Java.BankAppProject.DetailOfBank(
                    ...
                    } catch (MyProject.Java.BankAppProject.BankAccountException e) {
                        System.out.println("\n Error: " + e.getMessage());
                ...
                case 2:
                    ...
                    try {
                        ...
                        for (int i = 0; i < customers.size(); i++) {
                            MyProject.Java.BankAppProject.DetailOfBank cust = customers.get(i);
